variable "vm_config" {
  ...
  default = {
    "dc01" = {
      name               = "SCCM-DC"
      desc               = "DC - windows server 2019 - 192.168.10.40"
      cores              = 2
      memory             = 4096
    ...
    "srv01" = {
      name               = "SCCM-MECM"
      desc               = "SRV01 - MECM - windows server 2019 - 192.168.10.41"
      cores              = 2
      memory             = 4096
      clone              = "WinServer2019_x64"
      dns                = "192.168.10.1"
    ...
    "srv02" = {
      name               = "SCCM-MSSQL"
      desc               = "SRV02 - MSSQL - windows server 2019 - 192.168.10.42"
      cores              = 2
      memory             = 4096
      clone              = "WinServer2019_x64"
      dns                = "192.168.10.1"
    ...
    "ws01" = {
      name               = "SCCM-CLIENT"
      desc               = "SRV03 - CLIENT - windows server 2019 - 192.168.10.43"
      cores              = 2
      memory             = 4096
      clone              = "WinServer2019_x64"
      dns                = "192.168.10.1"
